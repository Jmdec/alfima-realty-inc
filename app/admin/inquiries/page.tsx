...
function InquiryDrawer({
  ...
  const price = isRent
    ? inquiry.property?.price_per_month
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              {inquiry.lead_email && (
                <a
                  href={`mailto:${inquiry.lead_email}`}
                  style={{
                    display: "flex",
                    alignItems: "center",
                    gap: 10,
                ...
                >
                  ...
                  <span
                    style={{ fontSize: 14, color: "#1d4ed8", fontWeight: 500 }}
                  >
                    {inquiry.lead_email}
                  </span>
                </a>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <span style={{ fontSize: 13, color: "#64748b" }}>
                  ...
                  <strong style={{ color: "#1e293b" }}>
                    {inquiry.preferred_contact.toUpperCase()}
                  </strong>
                </span>
              </div>
            </div>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    justifyContent: "center",
                    flexShrink: 0,
                    display: imgUrl(inquiry.property.thumbnail)
                      ? "none"
                      : "flex",
                  }}
                >
          ...
          {inquiry.viewing_date && (
            ...
            >
              ...
              <div>
                ...
                >
                  Preferred Viewing{" "}
                  {inquiry.viewing_time ? "Date & Time" : "Date"}
                </p>
                <p
                  style={{
                    fontSize: 14,
                ...
                >
                  ...
                  {inquiry.viewing_time && (
                    <span style={{ color: "#15803d" }}>
                      {" "}
                      · {formatTime(inquiry.viewing_time)}
                    </span>
                  )}
                </p>
              </div>
          ...
          {inquiry.agent && (
            ...
            >
              ...
              <div>
                <p
                  style={{ fontSize: 11, color: "#94a3b8", margin: "0 0 1px" }}
                >
                  Assigned Agent
                </p>
                <p
...
export default function AdminInquiriesPage() {
  ...
  const load = useCallback(
    async (page = 1, s = search, st = statusFilter) => {
      setLoading(true);
      try {
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 14, color: "#64748b", margin: 0 }}>
            {pagination?.total ?? inquiries.length} total inquiries from
      ...
      >
        {[
          ...
          >
            ...
            <p
              style={{ fontSize: 12, color: s.color, margin: 0, opacity: 0.8 }}
            >
              {s.label}
            </p>
          </div>
        ...
        <div style={{ overflowX: "auto", WebkitOverflowScrolling: "touch" }}>
          ...
          >
            <thead>
              ...
              >
                {["Lead", "Property", "Contact", "Date", "Status", ""].map(
                  (h) => (
                    <th
                      key={h}
                      style={{
                  ...
                  >
                    ...
                    <td style={{ padding: "13px 16px", whiteSpace: "nowrap" }}>
                      ...
                      >
                        <span style={{ fontSize: 15 }}>
                          {CONTACT_ICONS[inq.preferred_contact] ??
                            "\ud83d\udcac"}
                        </span>
                    ...
                    <td style={{ padding: "13px 16px", whiteSpace: "nowrap" }}>
                      ...
                      {inq.viewing_date && (
                        ...
                        >
                          🗓{" "}
                          {new Date(inq.viewing_date).toLocaleDateString(
                            "en-PH",
                            { month: "short", day: "numeric" },
                          )}
                          {inq.viewing_time
                            ? ` · ${formatTime(inq.viewing_time)}`
                            : ""}
                        </p>
                      )}
                    </td>
