              ...
              <div>
                ...
                {!isTakeover && (
                  <div className="flex items-center gap-1.5">
                    <div
                      className={`w-1.5 h-1.5 rounded-full ${phase === "human"
          ...
          {phase === "welcome" ? (
            ...
            <div className="flex-1 flex flex-col bg-neutral-950/90 overflow-y-auto">
              ...
              <div className="flex-1 flex flex-col gap-3 px-6 py-4">
                ...
                <div className="mt-1 space-y-3 rounded-xl border border-white/10 bg-white/5 p-3">
                  <p className="text-white/60 text-[11px] leading-relaxed">
                    Privacy Notice: Information you provide through this chatbot
                    may be used by ALFIMA Realty Inc. to respond to your
                    inquiry, understand your property requirements, connect you
                    with an appropriate representative, and provide
                    property-related assistance. Please review the Privacy Policy
                    of ALFIMA Realty Inc. for more information.
                  </p>
